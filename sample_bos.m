...
N_wlk=1500; % The number of random walkers
...
[E_ave,E_err,savedFile]=CPMC_Bos(Lx,Ly,Lz,N_par,kx,ky,kz,U,Uab,j,tx,ty,tz,deltau,N_wlk,N_blksteps,N_eqblk,N_blk,itv_pc,itv_nrm,itv_Em,suffix);
%% post-run:
