...
%   i: parameter used to calculate correlations
%   j: parameter used to calculate correlations
% Outputs:
%   e: the mixed estimator for the ground state energy of the input walker
%   ss_corr: spin-spin correlation in the mixed estimator
%   cc_corr: charge-charge correlation in the mixed estimator
