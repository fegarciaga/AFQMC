function [phi, O, w, invO_matrix_up, invO_matrix_dn] = V_alt_2(phi, phi_T, N_up, N_par, O, w, invO_matrix_up, invO_matrix_dn, deltau, U)
...
O_rat=RR(1)*RR(2);
w=abs(O_rat*exp(sample*F-0.5*F*F));
O=O*O_rat;    
