...
% Creates spin liquid trial wave-function for half-filling scenario
Phi_T=zeros(N_sites, N_par);
    
Phi_T(1, 1)=1/sqrt(2);    
Phi_T(2, 1)=1/sqrt(2);  
Phi_T(1, 1+N_up)=1/sqrt(2);    
Phi_T(2, 1+N_up)=1/sqrt(2);  

Phi_T(3, 2)=1/sqrt(2);    
Phi_T(6, 2)=1/sqrt(2);  
Phi_T(3, 2+N_up)=1/sqrt(2);    
Phi_T(6, 2+N_up)=1/sqrt(2); 

Phi_T(4, 3)=1/sqrt(2);    
Phi_T(7, 3)=1/sqrt(2);  
Phi_T(4, 3+N_up)=1/sqrt(2);    
Phi_T(7, 3+N_up)=1/sqrt(2); 

Phi_T(5, 4)=1/sqrt(2);    
Phi_T(10, 4)=1/sqrt(2);  
Phi_T(5, 4+N_up)=1/sqrt(2);    
Phi_T(10, 4+N_up)=1/sqrt(2); 

Phi_T(8, 5)=1/sqrt(2);    
Phi_T(12, 5)=1/sqrt(2);  
Phi_T(8, 5+N_up)=1/sqrt(2);    
Phi_T(12, 5+N_up)=1/sqrt(2); 

Phi_T(13, 6)=1/sqrt(2);    
Phi_T(9, 6)=1/sqrt(2);  
Phi_T(13, 6+N_up)=1/sqrt(2);    
Phi_T(9, 6+N_up)=1/sqrt(2); 

Phi_T(14, 7)=1/sqrt(2);    
Phi_T(15, 7)=1/sqrt(2);  
Phi_T(14, 7+N_up)=1/sqrt(2);    
Phi_T(15, 7+N_up)=1/sqrt(2); 

Phi_T(11, 8)=1/sqrt(2);    
Phi_T(16, 8)=1/sqrt(2);  
Phi_T(11, 8+N_up)=1/sqrt(2);    
Phi_T(16, 8+N_up)=1/sqrt(2); 
